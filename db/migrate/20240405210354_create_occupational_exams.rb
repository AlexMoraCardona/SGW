class CreateOccupationalExams < ActiveRecord::Migration[7.0]
  def change
    create_table :occupational_exams do |t|
    ...
    add_reference :occupational_exams, :entity, null: true, foreign_key: true
  end
end
