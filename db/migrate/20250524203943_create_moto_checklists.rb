class CreateMotoChecklists < ActiveRecord::Migration[7.0]
  def change
    create_table :moto_checklists do |t|
      t.date :date_list
      t.time :time_list
      t.string :plate_moto
     ...
     add_reference :moto_checklists, :user, null: true, foreign_key: true
     add_reference :moto_checklists, :entity, null: true, foreign_key: true
  end
end
