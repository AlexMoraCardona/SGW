class UnsafeCondition < ApplicationRecord
    ...
    def self.evaluarcondicion(unsafe)
        ...
        if @unsafe_condition.equipment_condition == 1 then 
            ...
            clasificacion = 0
            crearcondicion(@unsafe_condition, dato, clasificacion)
        end    
        ...
        if @unsafe_condition.inadequate_signage == 1 then 
            ...
            clasificacion = 0
            crearcondicion(@unsafe_condition, dato, clasificacion = 0)
        end    
    ...
    def self.crearcondicion(unsafe_condition, dato, clasificacion) 
        ...
        @matrix_unsafe_item.clasification_unsafe = clasificacion.to_i
