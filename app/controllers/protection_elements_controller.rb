class ProtectionElementsController < ApplicationController
    ...
    def protection_element_params
        params.require(:protection_element).permit(:name, :body_protect, :rule_protection, :durability, :date_sheet, :delivery_format, :personal_induction, :state_protection, :img_elem)
    end 
